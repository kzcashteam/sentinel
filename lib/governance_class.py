...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to ucomd "gobject list" output
    ...
    def ucomd_serialise(self):
        import ucomlib
        return ucomlib.SHIM_serialise_for_ucomd(self.serialise())
